...
public class InterestRequest {
    ...
    private Integer periodDays; // 7, 14, or 30 days
    ...
    private Boolean payLogisticsUpfront = true; // Whether to pay logistics with deposit
    private Boolean directBuy = false; // If true, user wants to buy directly (quantity >= minOrderQuantity). If false, show interest (any quantity)
}
